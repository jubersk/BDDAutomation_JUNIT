...
/**
 * The Class Constants. we will define all the folder loactions, file locations, log file locations, names and every
 * constant here
 */
...
public class Constants
{
	...
	public static final String STEP_DEFINITIONS = "com.automation.steps";

	/** The Constant FEATURES_PATH. */

	public static final String FEATURES_PATH = "src/test/resources/features";


	/** The Constant END_TO_END_FEATURES_PATH. */
	public static final String END_TO_END_FEATURES_PATH = "src/test/resources/feature";
	...
	/** The Constant TIME_OUT_DURATION. */
	public static final String TIME_OUT_DURATION = "120";
	...
	/** The Constant ROUND_OPEN_BRACES. */
	public static final String ROUND_OPEN_BRACES = ")";

	/** The Constant ROUND_CLOSED_BRACES. */
	public static final String ROUND_CLOSED_BRACES = ")";
	...
	/** The Constant CUCUMBER_EXTENT_REPORT_FORMATTING. */
	public static final String CUCUMBER_EXTENT_REPORT_FORMATTING = "com.cucumber.listener.ExtentCucumberFormatter";
	...
	public static final String Dollar = "$";
		...
		public static final String LOGIN_PAGE_OBJECTREPOSITORY_PROPERTY = "\\src\\test\\resources\\pageobjects\\LoginPage.property";
		
		/** The Constant HOME_PAGE_OBJECTREPOSITORY_PROPERTY. */
		public static final String HOME_PAGE_OBJECTREPOSITORY_PROPERTY = "\\src\\test\\resources\\pageobjects\\HomePage.property";

		/** The Constant CART_PAGE_OBJECTREPOSITORY_PROPERTY. */
		public static final String CART_CHECKOUT_PAGE_OBJECTREPOSITORY_PROPERTY = "\\src\\test\\resources\\pageobjects\\CartCheckoutPage.property";
	...
	/** The Constant EXTENT_REPORT_CONFIG_XML. */
	public static final String EXTENT_REPORT_CONFIG_XML = "\\src\\test\\resources\\properties\\config.xml";

	/** The Constant ZAPI_FILE_NAME. */
	public static final String ZAPI_FILE_NAME = "zapi.txt";
	...
	// TestReport Path
	public static final String TEST_DATA_PATH = "\\src\\test\\resources\\data\\testData.xlsx";

	/** The Constant LOG4J_FILE_PATH. */
	// LOG4J path
	public static final String LOG4J_FILE_PATH = "\\src\\test\\resources\\config\\log4j.properties";

	/** The Constant LOG_FILE_NAME_ATTRIBUTE. */
	public static final String LOG_FILE_NAME_ATTRIBUTE = "logFileName.log";

	/** The Constant CONFIG_AUTHORIZATION. */
	...
	/** The Constant GEKO_DRIVER. */
	// Mozilla
	// public static final String GEKO_DRIVER = "webdriver.gecko.driver";
	...
	/** The Constant ANDROID_CHROME_PATH. */
	public static final String ANDROID_CHROME_PATH = "/src/test/resources/drivers/mobilechromedriver.exe";

	/** The Constant ANDROID_CHROME_WEBDRIVER. */
	public static final String ANDROID_CHROME_WEBDRIVER = "webdriver.chrome.driver";

	/** The Constant EDGE_PATH. */
	public static final String EDGE_PATH = "/src/test/resources/drivers/edgedriver.exe";

	/** The Constant SCENARIO_ID. */
	// Test data constants
	...
	/** The Constant STEP_RESULT. */
	public static final String STEP_RESULT = "Step_Result";

	/** The Constant TEST_RESULT. */
	public static final String TEST_RESULT = "Test_Result";

	/** The Constant TEST_RESULTS_REPORT. */
	public static final String TEST_RESULTS_REPORT = "TestResults_Report";
	...
	/** The NOT IN STOCK product ***/
	public static final String NOT_IN_STOCK = "Not in stock";

	public static final Object ANDROID_AUTOMATION_NAME = "UiAutomator2";

	public static final String APK_FILES_PATH = "\\src\\test\\resources\\apkfiles\\UAMPMusicPlayerApp.apk";
